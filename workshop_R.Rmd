...
# Creating plots & reformatting data
...
We want to create a grouped bar chart that compares the average grades of male and female students. Before we can do this, we often need to reformat the data to work well with ggplot. This can be done in a simple step using

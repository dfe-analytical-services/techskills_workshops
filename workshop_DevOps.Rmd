...
\begin{verbatim}
git add .
git commit -m "Added new data and reading it in."
\end{verbatim}
...
* 1) Tidying the data
* 2) Creating the wide data plot
* 3) Creating the tidy data plot
...
\tcblower
Now to make the edits. Copy and paste the following code into the script \verb|R/utils.R|:
...
At this point you could try sourcing `main.R` in the R console and that should create the data frame `dftidied` (and hopefully not produce any errors!).

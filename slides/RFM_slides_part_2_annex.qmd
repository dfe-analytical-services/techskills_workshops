...
## <span style="color:#f67400;">Expert level:</span> Automated testing
...
- <span style="color:#f67400;">Expert level: </span> Pull requests can be set up to require automated tests to pass before they can be completed.

<span style="color:#f67400;"> Expert level example:</span> Automated tests on the dfeR `pretty_time()` function, using the testthat package
...
## <span style="color:#f67400;">Expert level:</span> Branch management
...
## <span style="color:#f67400;">Expert level:</span> Naming branches and commit messages

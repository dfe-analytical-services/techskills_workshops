...
- **API calls**: Use R to make API calls and ingest data directly into R. This can be done using the `httr` package.
...
- **Data cleaning**: Use R to clean data. This can be done using the `dplyr` package.

- **Data transformation**: Use R to transform data. This can be done using the `dplyr` package.

- **Data validation**: Use R to validate data. This can be done using the `assertthat` package.

## Output tables

- **Tables**: Use R to produce output tables. This can be done using the `kableExtra` package.
...
- **Commentary**: Use R to produce a commentary/report. This can be done using the `rmarkdown` package.
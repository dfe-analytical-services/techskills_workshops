...
1. **Understand the Context**:
   ...
   - Run the code locally if necessary.
2. **Be Constructive**:
...
## Example 1: Requesting Clarity and Improved Comments
...
- **Question**: I’m unclear on why the threshold is hardcoded to 80 here. Can you explain why 80 was chosen, and whether this is a departmental or industry standard? This might need to be more flexible for future updates."
- **Suggestion**: "It would be useful to add a comment explaining the significance of the 80 threshold here and whether it will change in future. This will help future maintainers understand the code."
...
attendance_threshold <- 80  # 80 is the department's standard threshold for 'passing' attendance

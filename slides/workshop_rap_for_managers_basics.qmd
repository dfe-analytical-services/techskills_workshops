...
This session is designed to cover some of the basic principles of RAP from the perspective of a manager, to outline the level of technical skills (R, SQL, Git) that we expect, and to give you a chance to ask any questions that you might have.

Coding and technical skills form a core part of our work as analysts in DfE. To continue producing high quality statistics, teams need to maintain consistent levels of capability at all levels, and so should be looking to build these skills at every opportunity. 
...
::: {.fragment .fade-up}
-   Create a clear audit trail using documentation to allow analysis to be easily reused where needed, either for repeated publications, or for PQ and FOI requests
:::
...
# What it means for managers: GSS expectations
...
::: {.column width="45%"}
- You should have sufficient levels of technical skills (R, SQL, Git) relevant to the work of your team to allow you to act as a technical leader and build capability in your team and the wider analyst community
...
- <span style="color:#f67400;">**Reality**</span>: Gradual, small changes towards best practice all add up - you don't have to change everything all at once! You have probably made much more progress towards best practice than you realise
...
It may feel difficult to work on your technical skills when you have fewer opportunities to do hands-on work. 

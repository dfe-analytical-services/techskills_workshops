...
# What are the differences between GitHub and Dev Ops?

::: {.fragment .fade-up}
- GitHub
  - Public
  - Can publish (Shiny dashboards, quarto and Rmarkdown html) to ShinyApps.io, GitHub pages etc.
:::
::: {.fragment .fade-up}
- Azure DevOps
  - Internal to DfE
  - Can manage secure permissions
  - Can publish (Shiny dashboards, quarto and Rmarkdown html) to rsconnect
:::
